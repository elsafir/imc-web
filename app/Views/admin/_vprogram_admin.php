          ...
          <div class="card card-primary card-outline">
            ...
            <?php } ?>
              ...
              <table id="example-program" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th class="resp-prog-3" style="width:10px;">No</th>
                  <th>Jenis</th>
                  <th>Judul</th>
                  <th class="resp-prog-3">Detail</th>
                ...
                <tr>
                  <td class="resp-prog-3"><?php echo $no++; ?></td> 
                  <td><?php echo $jenis_program; ?></td>
                  <td><?php echo $judul_program; ?></td>
                  <td class="resp-prog-3"><?php echo substr($detail_program, 0, 200); ?></td>
