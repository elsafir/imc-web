            ...
            <?php } ?>
              ...
              <table id="example-program" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th class="resp-com-2" >Jenis</th>
                  <th>Judul</th>
                  <th>Detail</th>
                  <th class="resp-com-2" >Foto</th>
                ...
                <tr>
                  ...
                  <td class="resp-com-2" ><?php echo $jenis_program; ?></td>
            ...
            <div class="modal-header">
              ...
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                        ...
                        <form role="form" name="myform" method="post" action="/Cprogram_user/tambah" enctype="multipart/form-data">
            ...
            <div class="modal-header">
              ...
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                      ...
                      <form role="form" name="myform" method="post" action="/Cprogram_user/ubah" enctype="multipart/form-data">
...
<div class="modal fade" id="hapus-data<?php echo $id_program;?>">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form action="/Cprogram_user/hapus/<?php echo $id_program;?>" method="post">
            <div class="modal-body">
