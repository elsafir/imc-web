            ...
            <div class="modal-header">
              ...
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                        ...
                        <form role="form" name="myform" method="post" action="/Ccommunity_user/tambah" enctype="multipart/form-data">
            ...
            <div class="modal-header">
              ...
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                      ...
                      <form role="form" name="myform" method="post" action="/Ccommunity_user/ubah" enctype="multipart/form-data">
...
<div class="modal fade" id="hapus-data<?php echo $id_community;?>">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form action="/Ccommunity_user/hapus/<?php echo $id_community;?>" method="post">
            <div class="modal-body">
