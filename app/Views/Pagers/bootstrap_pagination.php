...
?>
<nav aria-label="<?= lang('Pager.pageNavigation') ?>" style="position: relative;right: -5rem;width: fit-content;font-size: 1.2rem;box-shadow: 2px 2px 2px black;border-radius: 5px;">
    <ul class="pagination">
