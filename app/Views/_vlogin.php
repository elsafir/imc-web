<!DOCTYPE html>
<!-- Last Update : Rabu, 24 Juni 2020 -->
<!-- Updated by : Rizky Arief S -->
...
<head>
    ...
    <!-- Font Icon -->
    <link rel="stylesheet" href="/assets1/fonts/material-icon/css/material-design-iconic-font.min.css">
            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="/assets1/images/signin-image.jpg" class="resp" alt="sing up image"></figure>
...
<!--                             </div>
                        ...
                        <form action="<?= base_url('Clogin/loginProses') ?>" method="POST" class="register-form" id="login-form">
                            ...
                            <div class="form-group form-button">
                                ...
                                <!-- <a href="<?= base_url('Cadmin') ?>" class="form-submit">Log in</a> -->
                            </div>
                        </form>
