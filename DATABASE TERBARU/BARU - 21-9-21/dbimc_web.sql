...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Sep 2021 pada 03.05
...
(2, 2, 'ilyas aja', 1, 'ilyas@gmail.com', 'layaaas', '44892a2f-547c-4ebf-bfef-53fa803e7d29.jpg'),
...
(8, 2, 'Andi Firmansya', 2, '', '', NULL),
(9, 2, 'Jhon Edgard', 3, '', '', NULL),
(10, 3, 'Pastop Pasaribu', 2, '', '', NULL),
(13, 4, 'Retno Ekayanti', 2, 'retnoekayanti15@gmail.com', 'reykayanti', NULL);
...
INSERT INTO `events` (`id_events`, `id_pengguna`, `judul_events`, `detail_events`, `foto_events`, `slug_e`, `linkdaftar_event`) VALUES
(1, 1, 'Festival Indonesia Bangkit', 'Festival Indonesia Bangkit merupakan Events yang diselenggarakan oleh Indonesia Millenial Connect telah menyelenggarakan Event Sharing Virtual Terpanjang dan Terbesar selama 21 hari NONSTOP. \r\nFestival Indonesia Bangkit merupakan Events yang diselenggarakan oleh Indonesia Millenial Connect telah menyelenggarakan Event Sharing Virtual Terpanjang dan Terbesar selama 21 hari NONSTOP. ', 'fib_2.jpeg', 'festival-indonesia-bangkit', 'https://bit.ly/contoh/contoh.com'),
(3, 3, 'ECO TALKS', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur harum officia ipsam quasi autem id quisquam laboriosam reiciendis earum facere excepturi atque quam eius aperiam voluptate incidunt, sit, blanditiis nostrum?', 'feed.jpg', 'eco-talks', 'https://www.youtube.com/watch?v=DyDfgMOUjCI&list=RDL4ulcFtlB6I&index=27'),
(4, 1, 'HTML Events', 'An HTML event can be something the browser does, or something a user does.\r\nHere are some examples of HTML events:\r\n    An HTML web page has finished loading\r\n    An HTML input field was changed\r\n    An HTML button was clicked\r\nOften, when events happen, you may want to do something.\r\nJavaScript lets you execute code when events are detected.\r\nHTML allows event handler attributes, with JavaScript code, to be added to HTML elements.', 'html_2.jpg', 'html-events', 'https://bit.ly/sjoidjdaiodjoaidjoad.com'),
(12, 2, 'lalaa', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur harum officia ipsam quasi autem id quisquam laboriosam reiciendis earum facere excepturi atque quam eius aperiam voluptate incidunt, sit, blanditiis nostrum?', NULL, 'lalaa', 'https://www.youtube.com/watch?v=DyDfgMOUjCI&list=RDL4ulcFtlB6I&index=27');
...
--
ALTER TABLE `community`
  MODIFY `id_community` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT untuk tabel `events`
--
ALTER TABLE `events`
  MODIFY `id_events` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
