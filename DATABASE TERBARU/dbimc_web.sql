...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Sep 2021 pada 17.40
...
(2, 2, 'Muhammad Ilyas Arradya', 1, 'ben kemeja putih.jpg'),
...
(2, 2, 'Ngabuburit Dari Rumah Belajar', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum ullam explicabo magni, sint eligendi accusantium laudantium facere id necessitatibus rem dolore quidem reiciendis, soluta ipsa quisquam, beatae debitis adipisci provident. ', 'aufa.jpg', 'ngabuburit-dari-rumah'),
...
(8, 9, 'jhon', '$2y$10$z4BJGnNYtcIKn3YkBQJYLOwigvwltILCoUkfdW8N.45h7ajsAg9ri', 'User', 'Tidak Aktif');
...
CREATE TABLE `region` (
  ...
  `foto_region` varchar(50) DEFAULT NULL,
...
INSERT INTO `region` (`id_region`, `region`, `tentang_region`, `link_web`, `foto_region`, `slug_r`) VALUES
(1, 'Makassar', 'Makassar merupakan kota metropolitan terbesar di kawasan Indonesia Timur dan pada masa lalu pernah menjadi ibu kota Negara Indonesia Timur dan Provinsi Sulawesi. Makassar terletak di pesisir barat daya Pulau Sulawesi dan berbatasan dengan Selat Makassar d', 'https://www.imc-makassar.com', NULL, 'makassar'),
(2, 'Bandung', 'Bandung adalah kota metropolitan terbesar di Provinsi Jawa Barat, sekaligus menjadi ibu kota provinsi tersebut. Kota ini terletak 140 km sebelah tenggara Jakarta, dan merupakan kota terbesar di wilayah Pulau Jawa bagian barat.', 'https://www.imc-bandung.net', NULL, 'bandung'),
(3, 'Medan', 'Medan adalah ibu kota provinsi Sumatra Utara, Indonesia. Kota ini merupakan kota terbesar ketiga di Indonesia setelah DKI Jakarta dan Surabaya, serta kota terbesar di luar pulau Jawa. Kota Medan merupakan pintu gerbang wilayah Indonesia bagian barat denga', 'https://www.imc-medan.com', NULL, 'medan'),
...
(5, 'Kalimantan', 'Kalimantan iku pulo kang papané ana ing loring Pulo Jawa lan kuloning Pulo Sulawesi. Palemahaning pulo iki kapérang dadi wewengkoning telung nagara Brunei, Indonésia, lan Malaysia.', 'https://www.imc-kalimantan.com', NULL, 'kalimantan');
...
--
ALTER TABLE `pengguna`
  MODIFY `id_pengguna` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `region`
  MODIFY `id_region` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
